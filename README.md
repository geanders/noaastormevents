...
#> Error in find_file_name(year = year, file_type = file_type): No file found for that year and / or file type.
head(sept_1999_events)
#> Error in head(sept_1999_events): object 'sept_1999_events' not found
```
...
#> Error in find_file_name(year = year, file_type = file_type): No file found for that year and / or file type.
head(floyd_events)
#> Error in head(floyd_events): object 'floyd_events' not found
```
...
#> Error in eval(lhs, parent, parent): object 'floyd_events' not found
```
