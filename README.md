...
#> Error in registerNames(names, package, ".__global__", add): The namespace for package "noaastormevents" is locked; no changes in the global variables list may be made.
```
...
#> Error in head(oct_1999_events): object 'oct_1999_events' not found
```
...
#> Error in eval(expr, envir, enclos): object 'floyd_events' not found
```
