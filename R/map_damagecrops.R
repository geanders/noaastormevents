...
#' map_damage_crops(storm = "Floyd-1999", add_tracks = TRUE, clean_damage = TRUE)
#' }
#'
#' @importFrom dplyr %>%
#'
#' @export
map_damage_crops <- function(date_range = NULL, event_types = NULL,
                             east_only = TRUE, dist_limit = NULL, storm = NULL,
                             add_tracks = FALSE, clean_damage = FALSE){
