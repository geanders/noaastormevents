...
map_indirectinjuries <- function(data, begin_date, end_date, storm = F){
  ...
  IndirectInj0 = rbind(IndirectInj, region)
  aggIndirectInj = aggregate(value ~ region, data = IndirectInj0, sum)

  county_choropleth(aggIndirectInj, num_colors = 9, state_zoom = c("alabama", "arkansas",
                                                                 ...
                                                                 "wisconsin"), title = "Indirect Injuries")
}
