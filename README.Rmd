...
Currently, `hurricaneexposuredata` includes storm date for: 
...
Some users may wish to do more in-depth analysis, such as identifying storm events close in time and proximity to a specific storm track. `find_events` can be used to gather this data. A more in depth explanation of working with `find_events` can be found here,
...
To see more examples of plotting with `map_events`, visit the map_events article. 

## Find out more

There are many more details describing how this package works, as well as details on the Storm Events data. Visit the "Details" vignette to read more about this package's functionality. To see more information about the `find_events` and `map_events` functions, you can read each function's vignette that is also included with this package. 
