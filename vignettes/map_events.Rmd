...
With `map_events`, one of the primary functions in `noaastormevents`, users can map information in the dataframe returned by the `find_events` function. Mappable stats include:
