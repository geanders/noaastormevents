...
3. Next, pull out the last word in `cz_name` and try to match it to the county name
  in `county.fips`. Then check the last two words in `cz_name`, then check the last three words in `cz_name`.
