---
title: "Finding storm events"
author: "Brooke Anderson, Ziyu Chen, and Jordan Robinson"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Finding storm events}
...
To see examples of how data pulled from `find_events` can be visualized, visit the article on ["Mapping Events"](http://geanders.github.io/noaastormevents/articles/map_events.html). For more details on the underlying data and how the package processes it, see the ["Details" article](http://geanders.github.io/noaastormevents/articles/details.html).
