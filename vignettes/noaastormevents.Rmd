...
vignette: >
<<<<<<< HEAD
  %\VignetteIndexEntry{noaastormevents}
=======
  %\VignetteIndexEntry{Overview of noaastormevents}
>>>>>>> c9a5ad590518ab93716dbe7bf717f5f0be75127b
...
```{r}
my_data <- find_events(date_range = c("1999-09-14", "1999-09-18"))
save(my_data, file = "vignettes/data/my_data.RData")  
load("vignettes/data/my_data.RData")  
names(my_data)
...
save(oct_1999_events, file = "vignettes/data/oct_1999_events.RData")  
load("vignettes/data/oct_1999_events.RData")  
names(oct_1999_events)
...
save(floyd_events, file = "vignettes/data/floyd_events.RData")  
load("vignettes/data/floyd_events.RData")  
names(floyd_events)  
